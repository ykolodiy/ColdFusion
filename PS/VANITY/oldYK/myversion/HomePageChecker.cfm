<!---This Function WILL BE called in JeffVanity3.cfm, it  takes url as argument and goes thru upto 5 redirections and return yes if final destination is CAME back to home ps.com page and no if not--->
<cffunction name='httporhttps1' returntype='string'>
...
<cfset url2 = objGet1.ResponseHeader.Location>
			...
			<cfset url3 = objGet2.ResponseHeader.Location>
						...
						<cfset url4 = objGet3.ResponseHeader.Location>
								    ...
								    <!--- set correct url 5th  --->
										...
										<cfset url5 = objGet4.ResponseHeader.Location>
												        ...
												        useragent="#CGI.http_user_agent#"  />
				 										...
				 										<cfelse>
											            <cfif #findNoCase("https://www.pearsonschool.com/?acornRdt=1&acornRef=", "#url5#", 0)#>
														<cfreturn "YES">
														<cfelse>
														<cfreturn "NO">
														</cfif>
												...
												<cfelse>
									            <cfif #findNoCase("https://www.pearsonschool.com/?acornRdt=1&acornRef=", "#url4#", 0)#>
												<cfreturn "YES">
												<cfelse>
												<cfreturn "NO">
												</cfif>
	                            ...
	                            <cfelse>
  								<cfif #findNoCase("https://www.pearsonschool.com/?acornRdt=1&acornRef=", "#url3#", 0)#>
								<cfreturn "YES">
								<cfelse>
								<cfreturn "NO">
								</cfif>
					...
					<cfelse>
			        <cfif #findNoCase("https://www.pearsonschool.com/?acornRdt=1&acornRef=", "#url2#", 0)#>
					<cfreturn "YES">
					<cfelse>
					<cfreturn "NO">
			        </cfif>
...
<!---check if final url has this https://www.pearsonschool.com/?acornRdt=1&acornRef=   its is home page of ps.com  what to do with this--->